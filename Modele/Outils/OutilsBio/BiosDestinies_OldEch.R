...
statut[1:n,1:150]        <- buf[1:n,2:151]
...
salaire[1:n,1:150]        <- buf[1:n,2:151]
...
save (taille_max,anaiss,sexe,findet,pere,mere,conjoint,enf,n_enf,statut,salaire,age,trim_naiss,trim_act,k,chomind,salrefchom,file=(paste0(cheminsource,"Modele/Outils/OutilsBio/BiosDestinie2.RData")))
