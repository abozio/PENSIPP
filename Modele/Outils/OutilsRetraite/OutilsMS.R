...
#    la m??me possibilité de filtrage que pour la fonction minmax
# Exemple d'appel : 
# 
...
# -> Fonction "tirage"
#
# Tirage d'un sous échantillon selon un vecteur de probabilités d'inclusion "proba" dont la taille
# n correspond à la taille de la population de départ.  
#
# Exemples d'appel 
...
# -> fonction sel
# réduit une liste à ses premiers éléments ou aux éléments remplissant un
# critère donné
#
# Exemples d'appel
#
#  liste <- sel(liste,10)       # réduit la liste à ses 10 premiers éléments
#  liste <- sel(liste,-10)      # réduit la liste en éliminant ses 10 premiers éléments
