...
# Masse totale des ANC
mtotliq   <- (MPENLIQ[1,120]-MPENLIQ[7,120])/1e9    
...
#REF=c(mtotDF,mtotPA,mtotMC)
#CN=c(mtotDF_cn,mtotPA_cn,mtotMC_cn)
REF=c(mtotliqDF,mtotliqPA,mtotliqMC)
CN=c(mtotliqDF_cn,mtotliqPA_cn,mtotliqMC_cn)
par("mar")
#par(mar=c(5.1, 4.1, 4.1, 2.1))
par(mar=c(5.1, 3.1, 4.1, 2.1))
par(xpd=TRUE)
