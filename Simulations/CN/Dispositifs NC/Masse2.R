...
mtot[]   <- (MPENS[1,]-MPENS[4,])/1e9    
mtot_cn[]<- (MPENS_CN[1,]-MPENS_CN[4,])/1e9
...
mtotDF[]    <-(MPENS[2,]-MPENS[3,])/1e9   # Total DF 
mtotDF_cn[] <-(MPENS_CN[2,]-MPENS_CN[3,])/1e9  
#c(mtotDF,mtotDF_cn,mtotDF-mtotDF_cn)

# Masse des Périodes assimilées chomage (PA)
mtotPA[]   <-(MPENS[3,]-MPENS[4,])/1e9      
mtotPA_cn[]<-(MPENS_CN[3,]-MPENS_CN[4,])/1e9     
...
mtotliq_cn[]<- (MPENLIQ_CN[1,]-MPENLIQ_CN[4,])/1e9
...
mtotliqDF_cn[]<-(MPENLIQ_CN[2,]-MPENLIQ_CN[3,])/1e9  

# Masse des Périodes assimilées chomage (PA)
mtotliqPA[]  <-(MPENLIQ[5,]-MPENLIQ[7,])/1e9      
mtotliqPA_cn[]<-(MPENLIQ_CN[3,]-MPENLIQ_CN[4,])/1e9     
...
REF=c(mtotliqDF[120],mtotliqPA[135],mtotliqMC[135])
CN=c(mtotliqDF_cn[120],mtotliqPA_cn[135],mtotliqMC_cn[135])
par("mar")
#par(mar=c(5.1, 4.1, 4.1, 2.1))
par(mar=c(5.1, 3.1, 4.1, 2.1))
par(xpd=TRUE)
