...
#  1: Normal  
#  2: Neutralisation bonif      3: Neutralisation MDA   4: Neutralisation AVPF   
#  5: Neutralisation Periodes assimilés   6: Neutralisation Points Gratuits
#  7: Neutralisation mg et mc  
...
save.image("~/Desktop/PENSIPP 0.1/Simulations/CN/Dispositifs NC/Resulats.RData")