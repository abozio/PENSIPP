...
par(mar=c(6.1, 3.1, 4.1, 2.1))
par(xpd=TRUE)
plot   (seq(2010,2059,by=1),RATIOPENS[1,110:159],xlab="Annee", ylab="ratio retraite/PIB",ylim=c(min(RATIOPENS[,110:159],na.rm=TRUE),max(RATIOPENS[,110:159],na.rm=TRUE)),col="grey90",lwd=4,type="l",cex.axis=0.8)
points (seq(2010,2059,by=1),RATIOPENS[2,110:159],lwd=4,col="grey80",type="l")
points (seq(2010,2059,by=1),RATIOPENS[3,110:159],lwd=4,col="grey40",type="l")
points (seq(2010,2059,by=1),RATIOPENS[4,110:159],lwd=4,col="grey0",type="l")
title("Graphe 2.2 : Evolution du ratio retraites/PIB \nEffet des réformes", cex.main = 0.9)
legend.text <- c("Legislation 2012","Legislation 2003","Legislation 1993","Legislation 1992")
legend("bottom",inset=c(-0.2,-0.6),cex=0.8,legend.text, fill=c("grey0","grey40","grey80","grey90"))
