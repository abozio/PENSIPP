...
pdf(file=paste0(cheminsource,"Simulations/CN/Scenario de reference/Graphe2.pdf"))
plot   (seq(2010,2059,by=1),RATIOPENS[1,110:159],xlab="Annee", ylab="ratio retraite/PIB", ylab=titre,ylim=c(min(RATIOPENS[,110:159],na.rm=TRUE),max(RATIOPENS[,110:159],na.rm=TRUE)),col="grey40",lwd=2,type="l")
points (seq(2010,2059,by=1),RATIOPENS[2,110:159],lwd=2,col="grey30",type="l")
points (seq(2010,2059,by=1),RATIOPENS[3,110:159],lwd=2,col="grey20",type="l")
points (seq(2010,2059,by=1),RATIOPENS[4,110:159],lwd=2,col="grey0",type="l")
title("Graphe 2 : \nEvolution du ratio retraites/PIB")
